...
export const ChatCompletionToolSchema = z.object({
  ...
  parameters: z.record(z.unknown()).describe("The parameters the functions accepts, described as a JSON Schema object. See the guide](https://platform.openai.com/docs/guides/function-calling) for examples," +
