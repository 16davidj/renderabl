...
function App() {
    ...
    return ((0, jsx_runtime_1.jsxs)(material_1.Box, { sx: { display: 'flex' }, children: [(0, jsx_runtime_1.jsx)(material_1.Drawer, { sx: {
                ...
                }, variant: "permanent", anchor: "left", children: (0, jsx_runtime_1.jsxs)(material_1.List, { children: [(0, jsx_runtime_1.jsx)(material_1.ListItemButton, { onClick: () => setSelectedTab(0), children: (0, jsx_runtime_1.jsx)(material_1.ListItemText, { primary: "Context Data" }) }), (0, jsx_runtime_1.jsx)(material_1.ListItemButton, { onClick: () => setSelectedTab(1), children: (0, jsx_runtime_1.jsx)(material_1.ListItemText, { primary: "Tool Decider" }) }), (0, jsx_runtime_1.jsx)(material_1.ListItemButton, { onClick: () => setSelectedTab(2), children: (0, jsx_runtime_1.jsx)(material_1.ListItemText, { primary: "Component Generator" }) }), (0, jsx_runtime_1.jsx)(material_1.ListItemButton, { onClick: () => setSelectedTab(3), children: (0, jsx_runtime_1.jsx)(material_1.ListItemText, { primary: "Test" }) })] }) }), (0, jsx_runtime_1.jsxs)(material_1.Box, { component: "main", sx: { flexGrow: 1, bgcolor: 'background.default', p: 3 }, children: [(0, jsx_runtime_1.jsx)(material_1.AppBar, { position: "sticky", children: (0, jsx_runtime_1.jsx)(material_1.Toolbar, { children: (0, jsx_runtime_1.jsx)(material_1.Typography, { variant: "h6", sx: { flexGrow: 1 }, children: "Renderabl Infra App" }) }) }), selectedTab === 0 && (0, jsx_runtime_1.jsx)(contextTab_1.default, {}), selectedTab === 1 && ((0, jsx_runtime_1.jsx)(toolNodesTab_1.default, {})), selectedTab === 2 && ((0, jsx_runtime_1.jsx)(componentGenTab_1.default, {}))] })] }));
}
