...
exports.ChatCompletionToolSchema = zod_1.z.object({
    ...
    parameters: zod_1.z.record(zod_1.z.unknown()).describe("The parameters the functions accepts, described as a JSON Schema object. See the guide](https://platform.openai.com/docs/guides/function-calling) for examples," +
