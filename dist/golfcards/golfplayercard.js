...
const GolfPlayerCard = ({ name, year, height, birthday, rank, tour, almaMater, hometown, recentWin, firstWin, profilePictureUrl, sponsor, clubs, ball, messages, setMessages }) => {
